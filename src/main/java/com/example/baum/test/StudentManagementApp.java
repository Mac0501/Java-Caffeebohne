...
public class StudentManagementApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        students = FXCollections.observableArrayList(
                new Student("John", "Doe", "Computer Science", "Company A", "Advanced"),
                new Student("Jane", "Smith", "Mathematics", "Company B", "Intermediate"),
                new Student("Bob", "Johnson", "Physics", "Company A", "Beginner"),
                new Student("Alice", "Williams", "Computer Science", "Company C", "Advanced"),
                new Student("David", "Brown", "Chemistry", "Company B", "Intermediate")
        );
...
class Student {
    ...
    public Student(String name, String surname, String course, String company, String javaSkills) {
        this.name = name;
    ...
    public SimpleStringProperty getProperty(String columnName) {
        switch (columnName) {
            case "name":
            ...
            case "javaSkills":
                return new SimpleStringProperty(javaSkills);
            default:
                return null;
        }
    }
